<!-- This file mirrors SKILL.md for cross-tool compatibility (Codex, Gemini CLI, Cline, Roo Code, etc.) -->
<!-- Source of truth: SKILL.md — keep both files in sync when making changes. -->
